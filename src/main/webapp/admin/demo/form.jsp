        ...
        <div class="page-content fade-in-up">
            <div class="row">
                <div class="col-md-6">
                    <div class="ibox">
                        <div class="ibox-head">
                            <div class="ibox-title">Createx form</div>
            ...
            <div>
                <a class="adminca-banner" href="http://admincast.com/adminca/" target="_blank">
                    ...
                    <div class="wrap-1">
                        <div class="wrap-2">
                            <div>
                                <img src="admin/dist/assets/img/adminca-banner/adminca-preview.jpg" style="height:160px;margin-top:50px;">
                            </div>
                        ...
                        <div style="flex:1;">
                            <div class="d-flex justify-content-end wrap-3">
                                <div class="adminca-banner-b m-r-20">
                                    <img src="admin/dist/assets/img/adminca-banner/bootstrap.png" style="width:40px;margin-right:10px;">Bootstrap v4</div>
                                <div class="adminca-banner-b m-r-10">
                                    <img src="admin/dist/assets/img/adminca-banner/angular.png" style="width:35px;margin-right:10px;">Angular v5+</div>
                            </div>
                            <div class="dev-img">
                                <img src="admin/dist/assets/img/adminca-banner/sprite.png">
                            </div>
                        </div>
                    </div>
                </a>
